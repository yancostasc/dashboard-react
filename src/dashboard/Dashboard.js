...
const Dashboard = () => {
  ...
  const fakeDataUrl =
    "https://randomuser.me/api/?results=1&inc=name,picture&noinfo";
          ...
          <List
            ...
            renderItem={(film) => (
              <List.Item className="box">
                <Typography.Text className="filmTitle">
                  {film.title}
                </Typography.Text>
          ...
          <Col span={6}>
            <Card bordered={false} onClick={() => handleCardClick("Pessoas")}>
              <Spin spinning={loadingPeople}>
                <span className="cardTitle">Pessoas</span>
                <br></br>
                <h1 className="cardCount">
                  <img src={People} alt="Logo" /> {people}
                </h1>
              </Spin>
            </Card>
          </Col>
          ...
          <Col span={6}>
            ...
            >
              <Spin spinning={loadingPlanets}>
                ...
                <br></br>
                <h1 className="cardCount">
                  <img src={Planet} alt="Logo" /> {planets}
                </h1>
              </Spin>
            </Card>
          </Col>
          ...
          <Col span={6}>
            ...
            >
              <Spin spinning={loadingSpecies}>
                ...
                <br></br>
                <h1 className="cardCount">
                  <img src={Species} alt="Logo" /> {species}
                </h1>
              </Spin>
            </Card>
          </Col>
          ...
          <Col span={6}>
            ...
            >
              <Spin spinning={loadingStarships}>
                ...
                <br></br>
                <h1 className="cardCount">
                  <img src={Starship} alt="Logo" /> {starships}
                </h1>
              </Spin>
            </Card>
          </Col>
